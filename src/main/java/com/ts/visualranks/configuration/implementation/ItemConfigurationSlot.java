...
@Contextual
public class ItemConfigurationSlot {
    ...
    public ItemConfigurationSlot() { }

    public ItemConfigurationSlot(int slot, String itemName, List<String> itemLore, List<ItemFlag> itemFlags, Material itemMaterial, boolean itemGlow) {
        this.slot = slot;
